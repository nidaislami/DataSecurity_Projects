...
namespace TCP_Klienti
{
    public partial class Client : Form
    {
        ...
        public void SendRequestToSrv(string teksti)
        {
            try
            {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    // string json = JsonConvert.SerializeObject(shpenzimet1);
                    //string SendCommand = "INSERTSH " + json;
                    //string SendCommand = "Authentifikimi " + str_command;
